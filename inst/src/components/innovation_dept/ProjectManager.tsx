...
import { 
  Search, Filter, Briefcase, Banknote, TrendingUp, Users, Edit, Building2 
} from "lucide-react";
            ...
            <CardHeader className="p-4 sm:p-6 pb-3 relative">
              <div className="flex justify-between items-start mb-2 gap-2">
                ...
                <ProjectFormDialog 
                  ...
                  onSuccess={onRefresh}
                  trigger={
                    <Button variant="ghost" size="icon" className="h-7 w-7 -mr-1 -mt-1 text-muted-foreground hover:text-foreground shrink-0">
              ...
              <CardTitle className="text-lg sm:text-xl font-bold leading-tight line-clamp-1 pr-6" title={project.name}>
                {project.name}
              </CardTitle>
